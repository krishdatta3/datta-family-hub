  ...
  return (
    <>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:py-28">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-whatsapp px-6 py-3 text-sm font-medium text-whatsapp-foreground shadow-soft"
            >
              <MessageCircle className="h-4 w-4" /> WhatsApp वर विचारा
            </a>
            <Link
              to="/services"
              className="inline-flex items-center rounded-full border border-border bg-card px-6 py-3 text-sm font-medium text-foreground"
            >
              सेवा पहा
            </Link>
          </div>
          ...
          <div className="mt-10 grid max-w-3xl gap-3 sm:grid-cols-3">
            {[
              ...
              <div key={f.t} className="rounded-2xl border border-border bg-card/90 p-4">
      ...
      <section className="section">
        <h2 className="text-2xl text-foreground sm:text-3xl">आमचे चार व्यवसाय</h2>
      ...
      <section className="section">
        <h2 className="text-2xl text-foreground sm:text-3xl">ग्राहक काय म्हणतात</h2>
